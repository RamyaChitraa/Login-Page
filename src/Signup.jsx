      ...
      <div className="relative flex-1 flex flex-col">
        ...
        <header className="relative">
          <div className="relative mx-4 md:ml-14 flex justify-between items-center py-4">
            ...
            <button>
              <Link
                to={"/"}
                className="mr-4 md:mr-20 bg-[#E50914] text-sm md:text-base font-semibold rounded-md px-3 md:px-5 py-2 text-white"
              >
                Sign In
              </Link>
            </button>
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="mb-8 md:mb-36 text-center max-w-4xl">
            ...
            <p className="mt-6 md:mt-10 text-white text-sm md:text-base font-semibold px-4">
            ...
            <div className="flex flex-col md:flex-row gap-2 mt-6 px-4 max-w-2xl mx-auto">
              <input
                ...
                className="p-4 rounded-md flex-1 text-base bg-black/50 border-green-900 border-2 focus:border-white text-white"
